...
from tkinter import *
from controller import ControllerInserimentoImpiego


class ViewInserimentoImpiego:
    def __init__(self, lavoratore):
        ...
        self.button_inserisci = customtkinter.CTkButton(master=self.frame1, text="Inserisci e chiudi finestra",
                                                        command=lambda: ControllerInserimentoImpiego.ControllerInserimentoImpiego.add_job(lavoratore, dati, self.window))
